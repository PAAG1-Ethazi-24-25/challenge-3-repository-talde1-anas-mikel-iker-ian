...
def id_filtratu(my_list):
    ...
    filtratuak = [salmenta for salmenta in my_list if salmenta.getIda() == ida_bilatu]

    if filtratuak:
        print(f"\nID '{ida_bilatu}'-rekin bat datozen salmentak:")
        for salmenta in filtratuak:
            salmenta.print()
            print()
    else:
        print(f"\nEz da salmentarik aurkitu '{ida_bilatu}' IDarekin.")
